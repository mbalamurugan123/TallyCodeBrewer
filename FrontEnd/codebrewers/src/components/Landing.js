...
import '../css/codebattlefield.css'
...
const Landing = () => {
    ...
    return (
      <>
      <div className="code_editor_left">
        <h1 id="prob_desc">Problem Description</h1>
        ...
        <h1 id="prob_desc">Constraints</h1>
        <div className="question">
        <div>
      ...
      <div className="code_editor_right">
        <ToastContainer
          position="top-right"
          autoClose={2000}
          hideProgressBar={false}
          ...
          <div className="right-container flex flex-shrink-0 w-[30%] flex-col">
            ...
            <div className="flex flex-col items-end">
              ...
              <button
                ...
                disabled={!code}
                style={{ width: '250px' }}
                className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white font-semibold hover:text-black mt-5 py-2 px-15 border border-blue-500 hover:border-transparent rounded"
              >
